      ...
      {!isQuizCompleted ? (
        <div>
          ...
          <div className="flex justify-between mt-6">
            <button
              className={`bg-gray-500 text-white py-2 px-4 rounded-lg ${currentQuestionIndex === 0 ? 'opacity-50 cursor-not-allowed' : ''}`}
            ...
            <button
              className={`bg-blue-500 text-white py-2 px-4 rounded-lg ${currentQuestionIndex === currentQuiz.questions.length - 1 ? '' : 'hidden'}`}
